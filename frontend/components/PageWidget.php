...
class PageWidget extends Widget{
     ...
     */
    public $options = ['class' => 'orders-page'];
    /**
     ...
     */
    public $firstPageCssClass = 'iconfont';
    /**
     * @var string the CSS class for the "last" page button.
     */
    public $lastPageCssClass = 'iconfont';
    /**
     * @var string the CSS class for the "previous" page button.
     */
    public $prevPageCssClass = 'iconfont';
    /**
     * @var string the CSS class for the "next" page button.
     */
    public $nextPageCssClass = 'iconfont';
    /**
    ...
    protected function renderPageButtons()
    {
        ...
        if($pageCount){
            $buttons[] = $this->getPageInfo($pageCount,$currentPage+1,$this->pagination->getPageSize());
        }
...
//        }
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if ($disabled) {
            ...
            return Html::tag('i',$label, $options);

        }
        $linkOptions = $this->linkOptions;
        $linkOptions['data-page'] = $page;

        return Html::tag('i', Html::a($label, $this->pagination->createUrl($page), $linkOptions), $options);
    }
    ...
    protected function getPageInfo($totlePage,$currentPage,$nums){
        $html="<span>共".$totlePage."页</span><span>每页".$nums."条</span><span>第".$currentPage."/".$totlePage."页</span>";
        return $html;
    }
